...
// Component - FlagSI
export interface FlagSIProperties {
    className?: string;
}
export function FlagSI(properties: FlagSIProperties) {
    ...
    return (
        ...
        >
            <path fill="#ED1C23" d="M36 27v-4H0v4c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4z" />
