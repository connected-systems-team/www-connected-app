...
// Component - FlagCU
export interface FlagCUProperties {
    className?: string;
}
export function FlagCU(properties: FlagCUProperties) {
    ...
    return (
        ...
        >
            ...
            <path
                fill="#CF142B"
                d="M13.846 15l-6.923-5-5.541-4.002C.542 6.731 0 7.797 0 9v18c0 1.203.542 2.269 1.382 3.002L6.923 26l6.923-5L18 18l-4.154-3z"
            />
            <path
                fill="#FFF"
