...
// Component - FlagPY
export interface FlagPYProperties {
    className?: string;
}
export function FlagPY(properties: FlagPYProperties) {
    ...
    return (
        ...
        >
            <path fill="#0038A8" d="M0 27c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-4H0v4z" />
