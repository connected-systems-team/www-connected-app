...
// Component - FlagSX
export interface FlagSXProperties {
    className?: string;
}
export function FlagSX(properties: FlagSXProperties) {
    ...
    return (
        ...
        >
            ...
            />
            <path fill="#DC181E" d="M32 5H4C1.791 5 0 6.791 0 9v9h36V9c0-2.209-1.791-4-4-4z" />
            <path
                fill="#EEE"
            ...
            />
            <path fill="#FFF" d="M9.18 16.656H7.914c0-.172.283-.312.633-.312.349 0 .633.14.633.312z" />
            <path
                fill="#018830"
