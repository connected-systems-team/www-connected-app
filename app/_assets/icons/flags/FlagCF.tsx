...
// Component - FlagCF
export interface FlagCFProperties {
    className?: string;
}
export function FlagCF(properties: FlagCFProperties) {
    ...
    return (
        ...
        >
            ...
            <path
                fill="#FFCE00"
                d="M6.878 7.612l-.68-2.094-.681 2.094H3.316l1.781 1.294L4.417 11l1.781-1.294L7.979 11l-.681-2.094L9.08 7.612z"
            />
        </svg>
    );
}
