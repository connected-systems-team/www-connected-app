...
// Component - FlagEC
export interface FlagECProperties {
    className?: string;
}
export function FlagEC(properties: FlagECProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#FD0" d="M36 17V9c0-2.209-1.791-4-4-4H4C1.791 5 0 6.791 0 9v8h36z" />
            <path
                fill="#FD0"
            ...
            />
            <path fill="#A6D388" d="M19 19c0 .553-.448 1-1 1s-1-.447-1-1v-3c0-.552.448-1 1-1s1 .448 1 1v3z" />
            <path
                fill="#662113"
            ...
            <path fill="#CCD6DD" d="M17 11c0-.552.448 0 1 0s1-.552 1 0-.448 1-1 1-1-.448-1-1z" />
