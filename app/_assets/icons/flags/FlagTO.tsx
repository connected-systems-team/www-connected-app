...
// Component - FlagTO
export interface FlagTOProperties {
    className?: string;
}
export function FlagTO(properties: FlagTOProperties) {
    ...
    return (
        ...
        >
            <path
                fill="#C10000"
                d="M32 5H15v13H0v9c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4V9c0-2.209-1.791-4-4-4z"
            />
