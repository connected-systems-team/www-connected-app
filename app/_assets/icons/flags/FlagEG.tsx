...
// Component - FlagEG
export interface FlagEGProperties {
    className?: string;
}
export function FlagEG(properties: FlagEGProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#CE1225" d="M32 5H4C1.791 5 0 6.791 0 9v4h36V9c0-2.209-1.791-4-4-4z" />
            <path
                fill="#BF9300"
            ...
            />
            <path fill="#EEE" d="M17.375 18.891l-.563 2.14-.937-.187.969-2.75zm.699 0l.562 2.14.938-.187-.969-2.75z" />
            <path
                fill="#BF9300"
