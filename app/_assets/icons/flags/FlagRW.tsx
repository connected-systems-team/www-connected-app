...
// Component - FlagRW
export interface FlagRWProperties {
    className?: string;
}
export function FlagRW(properties: FlagRWProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#00A1DE" d="M32 5H4C1.791 5 0 6.791 0 9v12h36V9c0-2.209-1.791-4-4-4z" />
            <path
                fill="#FAD201"
