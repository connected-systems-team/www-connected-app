...
// Component - FlagTF
export interface FlagTFProperties {
    className?: string;
}
export function FlagTF(properties: FlagTFProperties) {
    ...
    return (
        ...
        >
            <path
                fill="#002395"
                d="M32 5H18v12H0v10c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4V9c0-2.209-1.791-4-4-4z"
            />
