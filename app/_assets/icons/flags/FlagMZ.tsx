...
// Component - FlagMZ
export interface FlagMZProperties {
    className?: string;
}
export function FlagMZ(properties: FlagMZProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#007168" d="M32 5H4C1.791 5 0 6.791 0 9v4h36V9c0-2.209-1.791-4-4-4z" />
