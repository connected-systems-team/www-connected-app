...
// Component - FlagBO
export interface FlagBOProperties {
    className?: string;
}
export function FlagBO(properties: FlagBOProperties) {
    ...
    return (
        ...
        >
            ...
            />
            <path fill="#A05A2D" d="M17.348 20.715l-.57 1.181-.102-.104-.222.307-.603-.328.749-1.464z" />
            <path
                fill="#D52B1E"
            ...
            />
            <path fill="#A05A2D" d="M18.652 20.715l.57 1.181.102-.104.222.307.603-.328-.749-1.464z" />
            <path
                fill="#D52B1E"
