...
// Component - FlagKM
export interface FlagKMProperties {
    className?: string;
}
export function FlagKM(properties: FlagKMProperties) {
    ...
    return (
        ...
        >
            <path fill="#3A75C4" d="M0 18v9c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-9H0z" />
            <path fill="#FFC61E" d="M36 18V9c0-2.209-1.791-4-4-4H4C1.791 5 0 6.791 0 9v9h36z" />
