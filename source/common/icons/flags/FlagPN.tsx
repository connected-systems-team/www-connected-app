...
// Component - FlagPN
export interface FlagPNProperties {
    className?: string;
}
export function FlagPN(properties: FlagPNProperties) {
    ...
    return (
        ...
        >
            ...
            />
            <path fill="#FFF100" d="M33.479 18.852c0 .277-.224.5-.5.5s-.5-.223-.5-.5c0-.276.224-.5.5-.5s.5.224.5.5z" />
            <path
                fill="#009A67"
