...
// Component - FlagCL
export interface FlagCLProperties {
    className?: string;
}
export function FlagCL(properties: FlagCLProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#D42D27" d="M0 18v9c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-9H0z" />
            <path
                fill="#FFF"
