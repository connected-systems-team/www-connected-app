...
// Component - FlagSV
export interface FlagSVProperties {
    className?: string;
}
export function FlagSV(properties: FlagSVProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#06209F" d="M17.821 17.774l-1.859-1.993s-.312 2.297.594 2.906c.906.61 1.265-.913 1.265-.913z" />
            <path fill="#FFF" d="M16.854 16.739l-.414-.444s-.213 1.783.693 2.393c-.437-.891-.279-1.949-.279-1.949z" />
            <path
                fill="#06209F"
                d="M17.821 18.602l-2.549-1.445s-.125 1.484.322 2.203c.446.719 2.085.766 2.312.062.228-.703-.085-.82-.085-.82z"
            />
            <path fill="#FFF" d="M16.194 17.679l-.477-.271s-.284 2.983 1.977 2.298c-1.498-.07-1.5-2.027-1.5-2.027z" />
            <path fill="#06209F" d="M17.989 17.774l1.859-1.993s.312 2.297-.594 2.906c-.905.61-1.265-.913-1.265-.913z" />
            <path fill="#FFF" d="M18.956 16.739l.414-.444s.213 1.783-.693 2.393c.437-.891.279-1.949.279-1.949z" />
            <path
                fill="#06209F"
                d="M17.989 18.602l2.549-1.445s.125 1.484-.321 2.203c-.446.719-2.085.766-2.312.062-.228-.703.084-.82.084-.82z"
            />
            <path fill="#FFF" d="M19.616 17.679l.479-.271s.283 2.983-1.979 2.298c1.498-.07 1.5-2.027 1.5-2.027z" />
