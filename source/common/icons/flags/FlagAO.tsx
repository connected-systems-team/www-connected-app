...
// Component - FlagAO
export interface FlagAOProperties {
    className?: string;
}
export function FlagAO(properties: FlagAOProperties) {
    ...
    return (
        ...
        >
            <path fill="#141414" d="M0 18v9c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-9H0z" />
            <path fill="#CE1B26" d="M36 18V9c0-2.209-1.791-4-4-4H4C1.791 5 0 6.791 0 9v9h36z" />
            <path
                fill="#F9D616"
