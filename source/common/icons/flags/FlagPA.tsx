...
// Component - FlagPA
export interface FlagPAProperties {
    className?: string;
}
export function FlagPA(properties: FlagPAProperties) {
    ...
    return (
        ...
        >
            <path fill="#EEE" d="M18 18V5H4C1.791 5 0 6.791 0 9v9h18zm0 0v13h14c2.209 0 4-1.791 4-4v-9H18z" />
