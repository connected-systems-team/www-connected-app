...
// Component - FlagCV
export interface FlagCVProperties {
    className?: string;
}
export function FlagCV(properties: FlagCVProperties) {
    ...
    return (
        ...
        >
            <path fill="#003893" d="M32 5H4C1.791 5 0 6.791 0 9v10h36V9c0-2.209-1.791-4-4-4z" />
            <path fill="#EEE" d="M0 19h36v2H0zm0 5h36v2H0z" />
            <path fill="#CF2027" d="M0 21v3h36v-3H0z" />
            <path fill="#003893" d="M4 31h28c2.209 0 4-1.791 4-4v-1H0v1c0 2.209 1.791 4 4 4z" />
            <path
                fill="#F7D116"
