...
// Component - FlagLS
export interface FlagLSProperties {
    className?: string;
}
export function FlagLS(properties: FlagLSProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#00209F" d="M32 5H4C1.791 5 0 6.791 0 9v4h36V9c0-2.209-1.791-4-4-4z" />
