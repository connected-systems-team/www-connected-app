...
// Component - FlagIQ
export interface FlagIQProperties {
    className?: string;
}
export function FlagIQ(properties: FlagIQProperties) {
    ...
    return (
        ...
        >
            <path fill="#141414" d="M0 27c0 2.209 1.791 4 4 4h28c2.209 0 4-1.791 4-4v-4H0v4z" />
            <path fill="#EEE" d="M0 13h36v10H0z" />
            <path fill="#DD2E44" d="M32 5H4C1.791 5 0 6.791 0 9v4h36V9c0-2.209-1.791-4-4-4z" />
            <g fill="#007A3C">
