...
// Component - FlagGQ
export interface FlagGQProperties {
    className?: string;
}
export function FlagGQ(properties: FlagGQProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#3E9A00" d="M32 5H4C1.791 5 0 6.791 0 9v4h36V9c0-2.209-1.791-4-4-4z" />
            <path
                fill="#0173CE"
