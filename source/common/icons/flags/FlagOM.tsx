...
// Component - FlagOM
export interface FlagOMProperties {
    className?: string;
}
export function FlagOM(properties: FlagOMProperties) {
    ...
    return (
        ...
        >
            ...
            <path fill="#DB161B" d="M36 13H9V5H4C1.791 5 0 6.791 0 9v18c0 2.209 1.791 4 4 4h5v-8h27V13z" />
            <g fill="#EEE">
