...
// Component - FlagMT
export interface FlagMTProperties {
    className?: string;
}
export function FlagMT(properties: FlagMTProperties) {
    ...
    return (
        ...
        >
            <path fill="#CF142B" d="M32 5H18v26h14c2.209 0 4-1.791 4-4V9c0-2.209-1.791-4-4-4z" />
