...
// Component - FlagEH
export interface FlagEHProperties {
    className?: string;
}
export function FlagEH(properties: FlagEHProperties) {
    ...
    return (
        ...
        >
            ...
            <path
                fill="#C4111B"
                d="M1.129 6.223C.433 6.943 0 7.92 0 9v18c0 1.08.433 2.057 1.129 2.777L12 18 1.129 6.223z"
            />
            <g fill="#C4111B">
